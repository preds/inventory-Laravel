...
@section('title', '>Assets Non Amortis')
...
<section class="mt-4">
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            <h3 class="text-dark mb-4"><span style="color: rgb(9, 179, 94);">>Assets Non Amortis</span></h3>
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="text-primary m-0 fw-bold">>Assets Non Amortis</p>
                            <div class="d-flex">
                        ...
                        <div class="table-responsive">
                            <table class="table my-0" id="dataTable">
                                ...
                                <tbody id="assetsTableBody">
                                    @foreach ($nonAmortizedAssets  as $asset)
    ...
    <div class="row">
        <div class="col-md-6 align-self-center">
            <p id="dataTable_info" class="dataTables_info" role="status" aria-live="polite">
                Montrer {{ $nonAmortizedAssets->firstItem() }} à {{ $nonAmortizedAssets->lastItem() }} de {{ $nonAmortizedAssets->total() }} entrées
            </p>
        </div>
        <div class="col-md-6">
            <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                {{ $nonAmortizedAssets->appends(request()->except('page'))->links('pagination::bootstrap-4') }}
            </nav>
        </div>
    </div>
